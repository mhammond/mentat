        ...
        match attribute_map.entry(entid) {
            Entry::Vacant(entry) => {
                ...
                builder.validate_install_attribute()
                       .chain_err(|| DbError::BadSchemaAssertion(format!("Schema alteration for new attribute with entid {} is not valid", entid)))?;
            ...
            Entry::Occupied(mut entry) => {
                builder.validate_alter_attribute()
                       .chain_err(|| DbError::BadSchemaAssertion(format!("Schema alteration for existing attribute with entid {} is not valid", entid)))?;
